...
__declspec(align(4))
    ...
    static unsigned char definputbox_dlg[] = {
        ...
        ,
...
static const INT definputbox_id_prompt = 1000, definputbox_id_edit1 = 1001, definputbox_id_edit2 = 1002;
...
INT_PTR CWin32InputBox::InputBoxEx(WIN32INPUTBOX_PARAM *param)
{
    ...
    INT_PTR r =
        ::DialogBoxIndirectParam(param->hInstance, dlgTemplate, param->hwndOwner, (DLGPROC)DlgProc, (LPARAM)&inputbox);
...
void CWin32InputBox::InitDialog()
{
    ...
    if (_param->bMultiline)
    {
        ...
        ::SetWindowPos(_param->hDlg, HWND_NOTOPMOST, 0, 0, rectDlg.right - rectDlg.left,
                       rectDlg.bottom - rectDlg.top - (rectEdit1.bottom - rectEdit1.top), SWP_NOMOVE);
    }
    else
    {
        ::SetWindowPos(_param->hDlg, HWND_NOTOPMOST, 0, 0, rectDlg.right - rectDlg.left,
